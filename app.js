...
function multiply(a,b){ //eslint-disable-line
  var calculatedMultiply = a * b;

  return[
    calculatedMultiply
    ,'The product of ' + a + ' and ' + b + ' is ' + calculatedMultiply + '.'
  ];
}
...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  var calculatedSum = sum(a, (sum(b,c)[0]))[0];
  console.log('calculatedSum :: ' + calculatedSum);
  var calculatedMultiply = multiply(a, (multiply(b,c)[0]))[0];
...
function sumArray(testArray){ //eslint-disable-line
  var calculatedSum = sum(testArray[0], (sum(testArray[1],testArray[2])[0]))[0];
  console.log('calculatedSum :: ' + calculatedSum);
...
function sumArray(testArray){ //eslint-disable-line
  ...
  for(var i = 0;i < testArray.length; i++){
    ...
    calculatedSum = sumAnswer(arrayValue,calculatedSum);
    console.log('calculatedSum :: ' + calculatedSum);
  }
