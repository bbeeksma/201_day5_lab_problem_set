...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  var calculatedSum = sum(a, parseInt(sum(b,c)[0]))[0];
...
function sumArray(testArray){ //eslint-disable-line
  var calculatedSum = sum(testArray[0], parseInt(sum(testArray[1],testArray[2])[0]))[0];
  console.log('calculatedSum :: ' + calculatedSum);
...
function multiplyArray(testArray){ //eslint-disable-line
  var calculatedMultiply = multiply(testArray[0], parseInt(multiply(testArray[1],testArray[2])[0]))[0];
  console.log('calculatedMultiply :: ' + calculatedMultiply);
